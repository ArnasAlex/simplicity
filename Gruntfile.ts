...
var define;
var requirejs;
class RequireConfigTransformer {
    ...
    public static getCoverageConfig(grunt: any): any {
        ...
        config.callback = function () {
            ...
            var requireFakeForTs: any = require;
